				...
				<div class="modal-body">
					<form class="form-horizontal" id="edit_customer_form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" id="edit_customerName" name="cust_name"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select id="edit_custIndustry" name="cust_industry" class="form-control">
									<option value="">--请选择--</option>
									<c:forEach items="${industryType}" var="item">
										<option value="${item.dict_id}"
											<c:if test="${item.dict_id == custIndustry}"> selected</c:if>>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select id="edit_custLevel" name="cust_level" class="form-control" >
									<option value="">--请选择--</option>
									<c:forEach items="${levelType}" var="item">
										<option value="${item.dict_id}"
											<c:if test="${item.dict_id == custLevel}"> selected</c:if>>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" id="edit_linkMan" name="cust_linkman" 
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text"  id="edit_phone" name="cust_phone"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" id="edit_mobile" name="cust_mobile"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text"  id="edit_zipcode" name="cust_zipcode"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text"  id="edit_address" name="cust_address"
